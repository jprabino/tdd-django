...
REPO_URL = 'https://github.com/jprabino/tdd-django.git'
...
def _update_virtualenv(source_folder):
    ...
    run (f'{virtualenv_folder}/bin/pip install --proxy="http://proxy.corp.globant.com:3128" -r {source_folder}/requirements.txt')
